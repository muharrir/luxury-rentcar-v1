...
export default function Checkout() {
	return (
		<>
			<section className="w-full bg-slate-100 md:flex">
				<div className="md:w-1/2 pb-10 md:h-screen md:flex md:items-center md:justify-center">
					<div>
						<Image className="w-full max-w-sm md:max-w-md 2xl:max-w-3xl mx-auto" src={imageMobil} alt="cars" />
				...
				<div className="md:flex md:justify-center md:items-center py-8 bg-slate-100 md:w-1/2 md:h-screen">
					<div className="max-w-sm mx-auto md:mx-0 lg:bg-white rounded-2xl 2xl:p-10 2xl:max-w-lg">
						...
						<div className="w-full px-5 text-sm lg:text-base">
							...
							<div class="mt-3 grid md:grid-cols-2 gap-4 md:gap-[30px] items-center">
								<PaymentType payment="MasterCard" name="mastercard" image={mastercard} />
								<PaymentType payment="Midtrans" name="midtrans" image={midtrans} />
							</div>
