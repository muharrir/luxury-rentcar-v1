    ...
    <div>
      ...
      >
        ...
        <div>
          ...
          <Link
            href={"/admin"}
            className="flex items-center gap-2.5 border-b border-slate-400 pb-5"
          >
            <Image
              src={"/assets/svgs/ic-logo.svg"}
              width={60}
              height={60}
              alt="ic-logo"
            />
            <span className="uppercase text-[#EEEEEE] font-bruno text-center text-2xl">
              luxury
            </span>
          </Link>
          {/* ITEM LIST */}
          <div className="transition-all duration-500">
            {/* MENU ITEM */}
            <div
              className="mt-10 flex items-center justify-between bg-[#0092CA] rounded-md py-2 px-[9px] cursor-pointer select-none"
